...
class MyPDF extends TCPDF {
    ...
    {   
     ...
     //   }
     //   else if(strtoupper($this->_app_language)==strtoupper('Thai')){
    //        return $lang_array['Thai'];
    //    }
        else{
    ...
    {   
        ...
        $this->Image($image_file, $x = 10, $y = 10, 30, '', '', '', 'T', false, 300, '', false, false, $border =0, false, false, false);
        return $this;
    }
