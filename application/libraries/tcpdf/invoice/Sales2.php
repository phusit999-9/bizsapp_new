...
class Sales extends MyPDF{
    ...
    public function _get_invoice_details()
    {
        ...
        $invoice_details .= '<br><b>'.$this->CI->lang->line('invoice_no').' :</b> <span style="font-size:14px;">'.$sales->sales_code.'</span>';
	...
	{	
		...
		$this->_invoice_name = "ใบเสร็จรับเงิน (ต้นฉบับ)";
		...
		<table >';
		    ...
		    $tbl .='<thead>
		        <tr style="background-color: #e4eaff ;" class="text-bold">
			        ...
			        $tbl .='<th colspan="1" style="width: '.$colW['disc'].'">'.$this->CI->lang->line("disc.").'</th>
		...
		$tbl .='<table>
		            <tbody>';
		            	...
		            	$tbl .='<tr nobr="true" class="text-bold">';
		                	...
		                	$tbl .='<td colspan="4"  style="width:'.($colWidthSize['sl_no']+$colWidthSize['description']+$colWidthSize['hsn']+$colWidthSize['unit_cost']).'%">';
