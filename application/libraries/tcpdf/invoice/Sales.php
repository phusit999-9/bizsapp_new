...
class Sales extends MyPDF{
    ...
    public function _get_invoice_details()
    {
        ...
        $h = 40;
        $invoice_details = "";
        $invoice_details = '<span style="color:rgb(65, 59, 212);">'.$this->CI->lang->line('original').'</span>';
	...
	{	
		...
		$this->_invoice_name = "ใบเสร็จรับเงิน ";
		...
		<table >';
			...
			<th colspan="1" class="text-center"  style="width: '.$colW['unit'].'">'.$this->CI->lang->line("unit").'</th>
		...
		//	}
			$tbl .='<th colspan="1" class="text-center"  class="text-right" style="width: '.$colW['disc'].'">'.$this->CI->lang->line("disc.").'</th>
              ...
              $q2=$this->CI->db->get();
				...
				//      $tbl .='<td colspan="1" style="width: '.$colW['hsn'].'">'.$res2->hsn.'</td>';
					...
					$tbl .='<td colspan="1" style="width: '.$colW['unit'].'">'.$res2->unit_name.'</td>'; 
				     $tbl .='<td colspan="1" class="text-right" style="width: '.$colW['unit_cost'].'">'.store_number_format( $res2->unit_total_cost).'</td>';
		...
		$tbl .='<table>
		            <tbody>';
		            	...
		            	$tbl .='<tr nobr="true" class="text-bold">';
		                	...
		                	$tbl .='<td colspan="4"  style="width:'.($colWidthSize['sl_no']+$colWidthSize['description']).'%">';
		                	$tbl .=$this->CI->lang->line("total");
		                	$tbl .='</td>';

		                

		                	$tbl .='<td colspan="1" class="text-right" style="width:'.($colWidthSize['qty']).'%">';
		...
		$tbl .='<table nobr="true">
		            <tbody>
		                <tr nobr="true">
                               	  ...
                               	  <td colspan="9" style="vertical-align:bottom;text-align:center;min-height:40px;height:40px;">
		                    	<div style="font-size:20px;text-align:left;">
			                    	<span style="color:rgb(65, 59, 212);font-style:italic;vertical-align:bottom;">
			                    	'.$this->CI->lang->line("terms_and_conditions").'
			                    	</span>
                                          <span style="color:rgb(65, 59, 212);font-style:italic;vertical-align:bottom;">
			                    	'.$this->CI->lang->line(" ").'
			                    	</span>
					  ...
					  <td colspan="9" style="vertical-align:bottom;text-align:center;min-height:40px;height:40px;">
		                    	<div style="font-size:20px;text-align:left;">
			                    	<span style="color:rgb(65, 59, 212);font-style:italic;vertical-align:bottom;">
			                    	'.$this->CI->lang->line("recipient_signature").'
			                    	:</span>
