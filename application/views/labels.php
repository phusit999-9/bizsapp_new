                                       ...
                                       <div class="box-footer col-sm-12">
                                          <center>
                                             ...
                                             <div class="col-md-3 col-md-offset-3">
                                                <button type="button" id="preview" class="btn btn-block btn-primary payments_modal" title="Preview Labels">Preview</button>
                                             </div>
                                             <div class="col-sm-3"><a href="<?= base_url()?>dashboard">
                                                <button type="button" class="btn btn-block btn-info" title="Go Dashboard">Close</button>
                                              </a>
                                            </div>
                                          </center>
                                       </div>
