                     ...
                     <div class="box box-primary">
                        ...
                        <div class="box-body table-responsive no-padding">
                           <table class="table table-bordered table-hover " id="report-data" >
                              ...
                              <!-- Total Purchase -->
                              <tr>
                                 <td><?= $this->lang->line('pur_before_tax'); ?></td>
                              ...
                              <!-- Total Purchase Paid Amount -->
                                ...
                                <tr>
                                 <td><?= $this->lang->line('total_purchase_amt'); ?></td>
                                 <td class="text-right text-bold total_purchase_amt"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                              <tr>
                                    ...
                                    <div class="form-group col-md-4">
                                       <label for="to_date">เลือกวันที่</label>
                                          ...
                                          <div class="input-group">
                                             ...
                                             <span>
                                             <i class="fa fa-calendar"></i> เลือกระหว่างวันที่
                                             </span>
                                             <i class="fa fa-caret-down"></i>
                                             </button>
                                          </div>
