          ...
          <table width="100%" height='100%' class="style_hidden fixed_table">
              <tr>
               ...
               <br/>
                    ...
                    <?php echo (!empty(trim($company_gst_no))) ? $this->lang->line('tax_id').": ".$company_gst_no."<br>" : '';?>
                   <?php echo (!empty(trim($company_vat_no))) ? $this->lang->line('branch').": ".$company_pan_no."<br>" : '';?>             
              ...
              <tr>
                ...
                <b style="font-size: 14px;"><?php echo $this->lang->line('')." ".$supplier_name; ?></b><br/>
                  <span style="font-size: 12px;">
  ...
  <tr>
    <td colspan="16">
      <span class='amt-in-word'>
        <?= $this->lang->line('return_note') .":<b>". nl2br($return_note)."</b>";?>
    </span>  
    </td>
  </tr>
