...
<body onload="window.print();"><!--  -->
   ...
   // $invoice_terms=nl2br($res3->invoice_terms);
	...
	<table width="95%" align="center">
		<tr>
			<td align="center" >
				<img src="<?= base_url($store_logo);?>" style= "height= " width="110px">
			</td>
		</tr>
...
?> <br/>	         
		...
		<tr><td align="center"><strong>-----------------<?= $this->lang->line('receipt'); ?>-----------------</strong></td></tr>
		<tr>
			<td>
				<table width="100%">
					<tr>
				...
				<!--	<tr>
						...
						<td><?= $this->lang->line('address').":".$customer_address; ?></td>
		...
		<tr>
			<td>
				...
				<?php } ?>				
					...
					<tr>
						<td style=" padding-left: 2px; padding-right: 2px; font-size:larger;" colspan="<?=$mrp_column+4?>" align="right"><?= $this->lang->line('grand_total'); ?></td>
			...
			<?php if($previous_balance_bit==1) {?>
				...
				<?php } ?>
					...
					<?php
						...
						<td colspan="<?=$mrp_column+5?>" align="left">
							<b><u><?= $this->lang->line('invoiceTerms'); ?>:</u></b> <br> 
