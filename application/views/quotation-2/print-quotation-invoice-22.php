...
<table autosize="1" style="overflow: wrap" id='mytable' align="center" width="100%" height='auto'  cellpadding="0" cellspacing="0"  >
        ...
        <th colspan="16">
          <table width="100%" height='100%' class="style_hidden fixed_table">
              <tr>
                <!-- First Half -->
                <td colspan="3">
                  <img src="<?= base_url($store_logo);?>" width='70%' height='auto'>
                </td>

                <td colspan="7">
                  <b style="font-size: 14px;"><?php echo $store_name; ?></b>
                  <?php echo (!empty(trim($company_vat_no))) ? $this->lang->line('')."  ".$company_vat_no." " : '';?> <br><br/>
                  ...
                  <span style="font-size: 12px;">
                      <?php echo $this->lang->line('name').": ".$customer_name; ?><br/>
                        ...
                        <?php 
                              ...
                              <?= $this->lang->line('phone'); ?>: <?php echo  $customer_phone; ?>,
                  ...
                  <span>
                    <table style="width: 100%;" class="style_hidden fixed_table">
                        ...
                        <td colspan='8' style="height:80px;">
                            <span><b> <?= $this->lang->line('customer'); ?></b></span>
                          </td> 
                          <td colspan='8'>
