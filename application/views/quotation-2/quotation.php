                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-sm-4">
                                             <select class="form-control" onchange="final_total();" id='discount_to_all_type' name="discount_to_all_type">
                                                <option value='in_percentage'>เปอร์เซ็นต์ / Per(%)</option>
                                                <option value='in_fixed'>จำนวนเงิน / Fixed</option>
                                             </select>
                                          </div>
                                    ...
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <table  class="col-md-9">
                                             ...
                                             <tr>
                                                <th class="text-right" style="font-size: 25px; color:green;"><?= $this->lang->line('grand_total'); ?></th>
                                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                   <h2><b id="total_amt" name="total_amt" style="color:red;">0.00</b> ฿</h2>
                                                </th>
                                             </tr>
                                          </table>
                                       </div>
                              ...
                              <center>
                                ...
                                ?>
                                 ...
                                 <div class="col-sm-3"><a href="<?= base_url()?>dashboard">
                                    <button type="button" class="btn btn-block btn-warning" title="Go Dashboard">ปิด</button>
                                  </a>
                                </div>
                              </center>
                           </div>
