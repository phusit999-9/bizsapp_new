    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          ...
          <address>
            <strong><?php echo  $store_name; ?></strong>  <?php echo (!empty(trim($company_vat_no))) ? $this->lang->line('')."  ".$company_vat_no." " : '';?> <br>
              ...
              <div class="col-md-12">
                 <div class="form-group">
                    ...
                    <table  class="col-md-11">
                       ...
                       <tr>
                          <th class="text-right" style="font-size: 27px; color:green;"><?= $this->lang->line('grand_total'); ?></th>
                          <th class="text-right" style="padding-left:10%;font-size: 17px;">
                             <h2><b id="total_amt" name="total_amt" style="color:red;"><?=store_number_format($grand_total);?></b></h2>
                          </th>
                       </tr>
                    </table>
                 </div>
      ...
      <div class="row no-print">
        <div class="col-xs-6">
          ...
          <a href="<?php echo $base_url; ?><?=$str2;?><?php echo  $quotation_id ?>" class="btn btn-warning">
          ...
          <?php if($CI->permissions('sales_add') && $sales_status=='') { ?>
            ...
            <i class="fa  fa-undo"></i> แปลงเป็นขายสินค้า
          </a>
          <?php }else{ ?>
            <a href="<?php echo $base_url; ?>sales/invoice/<?=get_sales_id_of_quotation($quotation_id)?>" class="btn btn-success">
            <i class="fa  fa-eye"></i> มุมมองใบเสร็จรับเงิน
          </a>
          <?php } ?>
          
          <a href="<?php echo $base_url; ?>quotation/print_invoice/<?php echo  $quotation_id ?>" target="_blank" class="btn btn-success">
