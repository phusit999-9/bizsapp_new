    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="<?php echo $base_url; ?>dashboard" class="navbar-brand" title="Go to Dashboard!"><b class="hidden-xs" style="color: skyblue; font-size:larger; ";><?php echo $STORE_NAME; ?></b><b class="hidden-lg">Bizs</b></a>
       ...
       <div class="navbar-custom-menu">
         <ul class="nav navbar-nav">
            ...
            <li class=""><a href="<?php echo $base_url; ?>pos" title="Create New POS Invoice"><i class="fa fa-calculator text-aqua " ></i> <span style="color: gold; font-size:larger"><?= $this->lang->line('new_invoice'); ?></span></a></li>
            <?php } ?> 
          ...
          <div class="box box-primary">
            ...
            <!--     <lable><?= $this->lang->line('previous_due'); ?> :<label class="customer_previous_due text-red" style="font-size: 18px;"><?=store_number_format(0)?></label></lable>    -->                               
                ...
                <div class="col-sm-8">
                  <div class="input-group" data-toggle="tooltip" title="Select Items">
                    <span class="input-group-addon" ><i class="fa fa-barcode"></i></span>
                     <input type="text" class="form-control" placeholder="ชื่อสินค้า/บาร์โค้ด/รหัสสินค้า" id="item_search" autofocus>
                 ...
                 <!-- SMS Sender while saving -->
                    ...
                    <div class="col-xs-4 ">
                      ...
                      <!--   <label>
                              <input type="checkbox" <?=$send_sms_checkbox;?> class="form-control" id="send_sms" name="send_sms" > <label for="sales_discount" class=" control-label"><?= $this->lang->line('send_sms_to_customer'); ?>
                                <i class="hover-q " data-container="body" data-toggle="popover" data-placement="top" data-content="หากช่องทำเครื่องหมายถูกปิดใช้งาน! คุณต้องเปิดใช้งานจากเมนู ส่งข้อความ -> SMS API <br><b>Note:ลูกค้าทั่วไปจะไม่ได้รับ SMS!</i></b>" data-html="true" data-trigger="hover" data-original-title="" title="ต้องการส่ง SMS ?">
                   ...
                   <!--  <label class="control-label pull-right hide div2 text-blue">
                      ...
                      <label class="control-label pull-left text-blue pointer" toggle="tooltip" title="<?= $this->lang->line('edit_invoice_tc')?>" data-toggle="modal" data-target="#terms-modal">
                         <span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Terms
                        </label> 
                    </div>
                </div>
              ...
              <div class="box-footer bg-gray">
                <div class="row">
                 ...
                 <div class="col-sm-3 text-right">
                  ...
                  <div class="col-sm-4 text-right">
                          ...
                          <?= ('<span style="font-size: 42px; color:red;" class="tot_grand text-bold"></span>');?>
                  </div>
                </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-12 text-right">
                    ...
                    <div class="col-sm-4">
                      <button type="button" id="hold_invoice" name="" class="btn bg-purple btn-block btn-flat btn-lg btnhold" title="Hold Invoice [Alt+H]" style="">
                      <i class="fa fa-hand-paper-o" aria-hidden="true"></i>
                       พักบิล alt+h
                    </button>
                    </div>
                    <div class="col-sm-4">
                      <button type="button" id="" name="" class="btn btnhold btn-success btn-block btn-flat btn-lg show_payments_modal" title="Multiple Payments [Alt+M]" style="">
             ...
             <!--     <div class="col-sm-3">
                    ...
                    <div class="col-sm-4">
                      <button type="button" id="pay_all" name="" class="btn btnhold btn-primary btn-block btn-flat btn-lg Alt_a" title="By Cash & Save [Alt+A]" style="">
                            <i class="fa fa-money" aria-hidden="true"></i>
                           ชำระด่วน alt+a
                          </button>
                    </div>
