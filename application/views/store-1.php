               ...
               <div class="col-md-12">
                  ...
                  <div class="nav-tabs-custom">
                     <ul class="nav nav-tabs">
                        ...
                        <?php if (!is_user()) { ?>
                           <li><a href="#tab_2" id='tab_2_btn' data-toggle="tab"><?= $this->lang->line('sales_doc'); ?></a></li>
                                       ...
                                       <div class="col-md-5">
                                          ...
                                          <?php if (pan_number()) { ?>
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                   <input type="text" class="form-control" id="pan_no" name="pan_no" placeholder="เลขสาขา 5 หลัก (00000)" value="<?php print $pan_no; ?>" onkeyup="shift_cursor(event,'store_website')">
                                          ...
                                          <?php if (vat_number()) { ?>
                                             <div class="form-group">
                                                <label for="vat_no" class="col-sm-4 control-label"><?= $this->lang->line('vat_amount'); ?><label class="text-danger">% * </label></label>
                                                <div class="col-sm-8">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-sm-8">
                                                ...
                                                <span id="signature_msg" style="display:block;" class="text-danger">Max Width/Height: 512px * 512px & Size: 1024kb </span>
                                             </div>
